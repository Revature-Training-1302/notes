...
* H2 Database
  - H2 database lets us run an in-memory database
  - The most temporary type of database because all of the data will be gone if the program ever stops
  - Very useful for testing
    - For example, testing an insert method, making sure that we are generating the proper ids would be impossible to automate with persistent database
    - With H2, our data will be reset every time
